...
class StrategyOptimizer:
    ...
    def __init__(self, config, strategy_name):
        ...
        try:
            ...
            self.logger.exception(e, True, f"{self.__class__.__name__} requires OctoBot-Evaluators and OctoBot-Trading "
    ...
    def find_optimal_configuration(self, TAs=None, time_frames=None, risks=None):
        if not self.is_computing:
            ...
            try:
                ...
                self.logger.error(f"{self.__class__.__name__} requires OctoBot-Evaluators and OctoBot-Trading "
                                  f"packages installed")
                raise e
            finally:
                self.current_test_suite = None
